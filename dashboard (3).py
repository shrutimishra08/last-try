...
def load_data():
    try:
        data = pd.read_csv("https://raw.githubusercontent.com/shrutimishra08/last-try/refs/heads/main/employee_data_100%20(1).csv")
        ...
        st.error(f"Failed to load dataset: {str(e)}. Please check the URL or CSV format.")
        st.stop()
